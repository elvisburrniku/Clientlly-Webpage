...
const generalResponses: { keywords: Record<string, string[]>; reply: L5; quickReplies?: L5[] }[] = [
  {
    ...
    reply: {
      sq: "💰 Planet tona janë:\n\n• Starter — €25/muaj (1 përdorues, 200 fatura)\n• Professional — €35/muaj (5 përdorues, 500 fatura)\n• Enterprise — €50/muaj (20 përdorues, fatura pa limit)\n\nTë gjitha planet përfshijnë të 16 modulet. Çmimet vjetore kanë 15% zbritje!",
      en: "💰 Our plans are:\n\n• Starter — €25/month (1 user, 200 invoices)\n• Professional — €35/month (5 users, 500 invoices)\n• Enterprise — €50/month (20 users, unlimited invoices)\n\nAll plans include all 16 modules. Annual pricing has a 15% discount!",
      es: "💰 Nuestros planes son:\n\n• Starter — €25/mes (1 usuario, 200 facturas)\n• Professional — €35/mes (5 usuarios, 500 facturas)\n• Enterprise — €50/mes (20 usuarios, facturas ilimitadas)\n\nTodos los planes incluyen los 16 módulos. Los precios anuales tienen un 15% de descuento!",
      de: "💰 Unsere Pläne sind:\n\n• Starter — €25/Monat (1 Benutzer, 200 Rechnungen)\n• Professional — €35/Monat (5 Benutzer, 500 Rechnungen)\n• Enterprise — €50/Monat (20 Benutzer, unbegrenzte Rechnungen)\n\nAlle Pläne enthalten alle 16 Module. Jährliche Preise haben 15% Rabatt!",
      mk: "💰 Нашите планови се:\n\n• Starter — €25/месец (1 корисник, 200 фактури)\n• Professional — €35/месец (5 корисници, 500 фактури)\n• Enterprise — €50/месец (20 корисници, неограничени фактури)\n\nСите планови ги вклучуваат сите 16 модули. Годишните цени имаат 15% попуст!",
    },
    quickReplies: [
  ...
  },
  {
    ...
    reply: {
      sq: "🎯 Ja si të zgjidhni planin e duhur:\n\n• Starter (€25/muaj) — Ideal për biznese të vogla me 1 punonjës\n• Professional (€35/muaj) — Për biznese në rritje me deri 5 punonjës\n• Enterprise (€50/muaj) — Për kompani më të mëdha me deri 20 përdorues\n\nNëse nuk jeni të sigurt, filloni me provën falas 14-ditore!",
      en: "🎯 Here's how to choose the right plan:\n\n• Starter (€25/month) — Ideal for small businesses with 1 employee\n• Professional (€35/month) — For growing businesses with up to 5 employees\n• Enterprise (€50/month) — For larger companies with up to 20 users\n\nIf you're not sure, start with the 14-day free trial!",
      es: "🎯 Así puede elegir el plan correcto:\n\n• Starter (€25/mes) — Ideal para negocios pequeños con 1 empleado\n• Professional (€35/mes) — Para negocios en crecimiento con hasta 5 empleados\n• Enterprise (€50/mes) — Para empresas más grandes con hasta 20 usuarios\n\nSi no está seguro, comience con la prueba gratuita de 14 días!",
      de: "🎯 So wählen Sie den richtigen Plan:\n\n• Starter (€25/Monat) — Ideal für kleine Unternehmen mit 1 Mitarbeiter\n• Professional (€35/Monat) — Für wachsende Unternehmen mit bis zu 5 Mitarbeitern\n• Enterprise (€50/Monat) — Für größere Unternehmen mit bis zu 20 Benutzern\n\nWenn Sie unsicher sind, starten Sie mit der 14-tägigen kostenlosen Testversion!",
      mk: "🎯 Еве како да го изберете вистинскиот план:\n\n• Starter (€25/месец) — Идеален за мали бизниси со 1 вработен\n• Professional (€35/месец) — За растечки бизниси со до 5 вработени\n• Enterprise (€50/месец) — За поголеми компании со до 20 корисници\n\nАко не сте сигурни, започнете со 14-дневниот бесплатен пробен период!",
    },
    quickReplies: [
