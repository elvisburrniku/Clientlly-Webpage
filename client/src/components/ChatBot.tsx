...
const generalResponses: { keywords: Record<string, string[]>; reply: L5; quickReplies?: L5[] }[] = [
  {
    ...
    reply: {
      sq: "💰 Planet tona janë:\n\n• Starter — €25/muaj (1 përdorues, fatura pa limit)\n• Professional — €35/muaj (deri në 5 përdorues, fatura pa limit + Le të Rritemi së Bashku)\n• Enterprise — €50/muaj (deri në 20 përdorues, fatura pa limit + Le të Rritemi së Bashku)\n\nTë gjitha planet përfshijnë të 16 modulet. Çmimet vjetore kanë 15% zbritje!",
      en: "💰 Our plans are:\n\n• Starter — €25/month (1 user, unlimited invoices)\n• Professional — €35/month (up to 5 users, unlimited invoices + Let's Grow Together)\n• Enterprise — €50/month (up to 20 users, unlimited invoices + Let's Grow Together)\n\nAll plans include all 16 modules. Annual pricing has a 15% discount!",
      es: "💰 Nuestros planes son:\n\n• Starter — €25/mes (1 usuario, facturas ilimitadas)\n• Professional — €35/mes (hasta 5 usuarios, facturas ilimitadas + Crezcamos Juntos)\n• Enterprise — €50/mes (hasta 20 usuarios, facturas ilimitadas + Crezcamos Juntos)\n\nTodos los planes incluyen los 16 módulos. Los precios anuales tienen un 15% de descuento!",
      de: "💰 Unsere Pläne sind:\n\n• Starter — €25/Monat (1 Benutzer, unbegrenzte Rechnungen)\n• Professional — €35/Monat (bis zu 5 Benutzer, unbegrenzte Rechnungen + Gemeinsam Wachsen)\n• Enterprise — €50/Monat (bis zu 20 Benutzer, unbegrenzte Rechnungen + Gemeinsam Wachsen)\n\nAlle Pläne enthalten alle 16 Module. Jährliche Preise haben 15% Rabatt!",
      mk: "💰 Нашите планови се:\n\n• Starter — €25/месец (1 корисник, неограничени фактури)\n• Professional — €35/месец (до 5 корисници, неограничени фактури + Да Растеме Заедно)\n• Enterprise — €50/месец (до 20 корисници, неограничени фактури + Да Растеме Заедно)\n\nСите планови ги вклучуваат сите 16 модули. Годишните цени имаат 15% попуст!",
    },
    quickReplies: [
  ...
  },
  {
    ...
    reply: {
      sq: "🏷️ Po! Ofrojmë zbritje 15% për pagesa vjetore:\n\n• Starter (1 përdorues): €300/vit → €255/vit (kurseni €45)\n• Professional (deri në 5 përdorues): €420/vit → €357/vit (kurseni €63)\n• Enterprise (deri në 20 përdorues): €600/vit → €510/vit (kurseni €90)\n\nMe planet Professional dhe Enterprise fitoni më shumë përdorues! Migrimi i të dhënave është plotësisht FALAS!",
      en: "🏷️ Yes! We offer a 15% discount for annual payments:\n\n• Starter (1 user): €300/year → €255/year (save €45)\n• Professional (up to 5 users): €420/year → €357/year (save €63)\n• Enterprise (up to 20 users): €600/year → €510/year (save €90)\n\nWith Professional and Enterprise plans you get more users! Data migration is completely FREE!",
      es: "🏷️ Sí! Ofrecemos un 15% de descuento para pagos anuales:\n\n• Starter (1 usuario): €300/año → €255/año (ahorre €45)\n• Professional (hasta 5 usuarios): €420/año → €357/año (ahorre €63)\n• Enterprise (hasta 20 usuarios): €600/año → €510/año (ahorre €90)\n\nCon los planes Professional y Enterprise obtiene más usuarios! La migración de datos es completamente GRATIS!",
      de: "🏷️ Ja! Wir bieten 15% Rabatt für jährliche Zahlung:\n\n• Starter (1 Benutzer): €300/Jahr → €255/Jahr (sparen Sie €45)\n• Professional (bis zu 5 Benutzer): €420/Jahr → €357/Jahr (sparen Sie €63)\n• Enterprise (bis zu 20 Benutzer): €600/Jahr → €510/Jahr (sparen Sie €90)\n\nMit den Professional- und Enterprise-Plänen erhalten Sie mehr Benutzer! Datenmigration ist komplett KOSTENLOS!",
      mk: "🏷️ Да! Нудиме 15% попуст за годишно плаќање:\n\n• Starter (1 корисник): €300/год → €255/год (заштедете €45)\n• Professional (до 5 корисници): €420/год → €357/год (заштедете €63)\n• Enterprise (до 20 корисници): €600/год → €510/год (заштедете €90)\n\nСо Professional и Enterprise плановите добивате повеќе корисници! Миграцијата на податоци е целосно БЕСПЛАТНА!",
    },
    quickReplies: [
