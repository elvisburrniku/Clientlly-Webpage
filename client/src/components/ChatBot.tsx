...
const generalResponses: { keywords: Record<string, string[]>; reply: L5; quickReplies?: L5[] }[] = [
  {
    ...
    reply: {
      sq: "💰 Planet tona janë:\n\n• Starter — €25/muaj\n  1 përdorues, fatura pa limit\n\n• Professional — €35/muaj\n  Deri në 5 përdorues, fatura pa limit\n  + Le të Rritemi së Bashku\n\n• Enterprise — €50/muaj\n  Deri në 20 përdorues, fatura pa limit\n  + Le të Rritemi së Bashku\n\nTë gjitha planet përfshijnë të 16 modulet.\nÇmimet vjetore kanë 15% zbritje!",
      en: "💰 Our plans are:\n\n• Starter — €25/month\n  1 user, unlimited invoices\n\n• Professional — €35/month\n  Up to 5 users, unlimited invoices\n  + Let's Grow Together\n\n• Enterprise — €50/month\n  Up to 20 users, unlimited invoices\n  + Let's Grow Together\n\nAll plans include all 16 modules.\nAnnual pricing has a 15% discount!",
      es: "💰 Nuestros planes son:\n\n• Starter — €25/mes\n  1 usuario, facturas ilimitadas\n\n• Professional — €35/mes\n  Hasta 5 usuarios, facturas ilimitadas\n  + Crezcamos Juntos\n\n• Enterprise — €50/mes\n  Hasta 20 usuarios, facturas ilimitadas\n  + Crezcamos Juntos\n\nTodos los planes incluyen los 16 módulos.\nLos precios anuales tienen un 15% de descuento!",
      de: "💰 Unsere Pläne sind:\n\n• Starter — €25/Monat\n  1 Benutzer, unbegrenzte Rechnungen\n\n• Professional — €35/Monat\n  Bis zu 5 Benutzer, unbegrenzte Rechnungen\n  + Gemeinsam Wachsen\n\n• Enterprise — €50/Monat\n  Bis zu 20 Benutzer, unbegrenzte Rechnungen\n  + Gemeinsam Wachsen\n\nAlle Pläne enthalten alle 16 Module.\nJährliche Preise haben 15% Rabatt!",
      mk: "💰 Нашите планови се:\n\n• Starter — €25/месец\n  1 корисник, неограничени фактури\n\n• Professional — €35/месец\n  До 5 корисници, неограничени фактури\n  + Да Растеме Заедно\n\n• Enterprise — €50/месец\n  До 20 корисници, неограничени фактури\n  + Да Растеме Заедно\n\nСите планови ги вклучуваат сите 16 модули.\nГодишните цени имаат 15% попуст!",
    },
    quickReplies: [
  ...
  },
  {
    ...
    reply: {
      sq: "🎯 Ja si të zgjidhni planin e duhur:\n\n• Starter (€25/muaj)\n  Ideal për biznese të vogla me 1 punonjës\n  Fatura pa limit\n\n• Professional (€35/muaj)\n  Për biznese në rritje me deri në 5 punonjës\n  Fatura pa limit + Le të Rritemi së Bashku\n\n• Enterprise (€50/muaj)\n  Për kompani më të mëdha me deri në 20 përdorues\n  Fatura pa limit + Le të Rritemi së Bashku\n\nTë gjitha planet përfshijnë 16 module.\nNëse nuk jeni të sigurt, filloni me provën falas 14-ditore!",
      en: "🎯 Here's how to choose the right plan:\n\n• Starter (€25/month)\n  Ideal for small businesses with 1 user\n  Unlimited invoices\n\n• Professional (€35/month)\n  For growing businesses with up to 5 users\n  Unlimited invoices + Let's Grow Together\n\n• Enterprise (€50/month)\n  For larger companies with up to 20 users\n  Unlimited invoices + Let's Grow Together\n\nAll plans include 16 modules.\nIf you're not sure, start with the 14-day free trial!",
      es: "🎯 Así puede elegir el plan correcto:\n\n• Starter (€25/mes)\n  Ideal para negocios pequeños con 1 usuario\n  Facturas ilimitadas\n\n• Professional (€35/mes)\n  Para negocios en crecimiento con hasta 5 usuarios\n  Facturas ilimitadas + Crezcamos Juntos\n\n• Enterprise (€50/mes)\n  Para empresas más grandes con hasta 20 usuarios\n  Facturas ilimitadas + Crezcamos Juntos\n\nTodos los planes incluyen 16 módulos.\nSi no está seguro, comience con la prueba gratuita de 14 días!",
      de: "🎯 So wählen Sie den richtigen Plan:\n\n• Starter (€25/Monat)\n  Ideal für kleine Unternehmen mit 1 Benutzer\n  Unbegrenzte Rechnungen\n\n• Professional (€35/Monat)\n  Für wachsende Unternehmen mit bis zu 5 Benutzern\n  Unbegrenzte Rechnungen + Gemeinsam Wachsen\n\n• Enterprise (€50/Monat)\n  Für größere Unternehmen mit bis zu 20 Benutzern\n  Unbegrenzte Rechnungen + Gemeinsam Wachsen\n\nAlle Pläne enthalten 16 Module.\nWenn Sie unsicher sind, starten Sie mit der 14-tägigen kostenlosen Testversion!",
      mk: "🎯 Еве како да го изберете вистинскиот план:\n\n• Starter (€25/месец)\n  Идеален за мали бизниси со 1 корисник\n  Неограничени фактури\n\n• Professional (€35/месец)\n  За растечки бизниси со до 5 корисници\n  Неограничени фактури + Да Растеме Заедно\n\n• Enterprise (€50/месец)\n  За поголеми компании со до 20 корисници\n  Неограничени фактури + Да Растеме Заедно\n\nСите планови вклучуваат 16 модули.\nАко не сте сигурни, започнете со 14-дневниот бесплатен пробен период!",
    },
    quickReplies: [
  ...
  },
  {
    ...
    reply: {
      sq: "🏷️ Po! Ofrojmë zbritje 15% për pagesa vjetore:\n\n• Starter (1 përdorues):\n  €300/vit → €255/vit (kurseni €45)\n\n• Professional (deri në 5 përdorues):\n  €420/vit → €357/vit (kurseni €63)\n\n• Enterprise (deri në 20 përdorues):\n  €600/vit → €510/vit (kurseni €90)\n\nMe planet Professional dhe Enterprise fitoni më shumë përdorues!\nMigrimi i të dhënave është plotësisht FALAS!",
      en: "🏷️ Yes! We offer a 15% discount for annual payments:\n\n• Starter (1 user):\n  €300/year → €255/year (save €45)\n\n• Professional (up to 5 users):\n  €420/year → €357/year (save €63)\n\n• Enterprise (up to 20 users):\n  €600/year → €510/year (save €90)\n\nWith Professional and Enterprise plans you get more users!\nData migration is completely FREE!",
      es: "🏷️ Sí! Ofrecemos un 15% de descuento para pagos anuales:\n\n• Starter (1 usuario):\n  €300/año → €255/año (ahorre €45)\n\n• Professional (hasta 5 usuarios):\n  €420/año → €357/año (ahorre €63)\n\n• Enterprise (hasta 20 usuarios):\n  €600/año → €510/año (ahorre €90)\n\nCon los planes Professional y Enterprise obtiene más usuarios!\nLa migración de datos es completamente GRATIS!",
      de: "🏷️ Ja! Wir bieten 15% Rabatt für jährliche Zahlung:\n\n• Starter (1 Benutzer):\n  €300/Jahr → €255/Jahr (sparen Sie €45)\n\n• Professional (bis zu 5 Benutzer):\n  €420/Jahr → €357/Jahr (sparen Sie €63)\n\n• Enterprise (bis zu 20 Benutzer):\n  €600/Jahr → €510/Jahr (sparen Sie €90)\n\nMit den Professional- und Enterprise-Plänen erhalten Sie mehr Benutzer!\nDatenmigration ist komplett KOSTENLOS!",
      mk: "🏷️ Да! Нудиме 15% попуст за годишно плаќање:\n\n• Starter (1 корисник):\n  €300/год → €255/год (заштедете €45)\n\n• Professional (до 5 корисници):\n  €420/год → €357/год (заштедете €63)\n\n• Enterprise (до 20 корисници):\n  €600/год → €510/год (заштедете €90)\n\nСо Professional и Enterprise плановите добивате повеќе корисници!\nМиграцијата на податоци е целосно БЕСПЛАТНА!",
    },
    quickReplies: [
  ...
  },
  {
    ...
    reply: {
      ...
      en: "🤝 Welcome to the Clientlly Affiliate Program!\n\nEarn 10% commission on every payment — forever. Choose what you'd like to know:",
      es: "🤝 Bienvenido al Programa de Afiliados de Clientlly!\n\nGane 10% de comisión en cada pago — para siempre. Elija lo que desea saber:",
      de: "🤝 Willkommen beim Clientlly Affiliate-Programm!\n\nVerdienen Sie 10% Provision auf jede Zahlung — für immer. Wählen Sie, was Sie wissen möchten:",
      mk: "🤝 Добредојдовте во Афилијат Програмата на Clientlly!\n\nЗаработете 10% провизија на секое плаќање — засекогаш. Изберете што сакате да знаете:",
    },
    quickReplies: [
      { sq: "💰 Sa komision fitoj?", en: "💰 How much do I earn?", es: "💰 Cuanto gano?", de: "💰 Wie viel verdiene ich?", mk: "💰 Колку заработувам?" },
      { sq: "🏦 Si paguhem?", en: "🏦 How do I get paid?", es: "🏦 Como me pagan?", de: "🏦 Wie werde ich bezahlt?", mk: "🏦 Kako се плаќам?" },
      { sq: "📊 Si e di kush është aktiv?", en: "📊 How do I track clients?", es: "📊 Como sigo a mis clientes?", de: "📊 Wie verfolge ich Kunden?", mk: "📊 Kako ги следам клиентите?" },
      { sq: "📋 Si aplikoj?", en: "📋 How do I apply?", es: "📋 Como aplico?", de: "📋 Wie bewerbe ich mich?", mk: "📋 Kako аплицирам?" },
    ],
  },
  {
    keywords: {
      sq: ['sa komision fitoj', 'sa fitoj', 'sa mund të fitoj', 'komision fitoj', 'sa përqind'],
      en: ['how much do i earn', 'how much earn', 'how much can i earn', 'commission earn', 'what percent'],
      es: ['cuanto gano', 'cuanto puedo ganar', 'que porcentaje', 'comision gano'],
      de: ['wie viel verdiene ich', 'wie viel kann ich verdienen', 'welcher prozentsatz', 'provision verdiene'],
      mk: ['колку заработувам', 'колку можам да заработам', 'кој процент', 'провизија заработувам'],
    },
    reply: {
      sq: "💰 Fitoni 10% komision për çdo pagesë që bën klienti juaj — PËRGJITHMONË!\n\n📊 Shembuj konkretë:\n\n• 1 klient Starter (€25/muaj)\n  → Ju fitoni €2.50/muaj = €30/vit\n\n• 5 klientë Professional (€35/muaj)\n  → Ju fitoni €17.50/muaj = €210/vit\n\n• 10 klientë Enterprise (€50/muaj)\n  → Ju fitoni €50/muaj = €600/vit\n\n✅ Sa më shumë klientë referoni, aq më shumë fitoni — pa asnjë limit!",
      en: "💰 You earn 10% commission on every payment your client makes — FOREVER!\n\n📊 Concrete examples:\n\n• 1 Starter client (€25/month)\n  → You earn €2.50/month = €30/year\n\n• 5 Professional clients (€35/month)\n  → You earn €17.50/month = €210/year\n\n• 10 Enterprise clients (€50/month)\n  → You earn €50/month = €600/year\n\n✅ The more clients you refer, the more you earn — with no limit!",
      es: "💰 Gana 10% de comisión en cada pago que hace su cliente — PARA SIEMPRE!\n\n📊 Ejemplos concretos:\n\n• 1 cliente Starter (€25/mes)\n  → Gana €2.50/mes = €30/año\n\n• 5 clientes Professional (€35/mes)\n  → Gana €17.50/mes = €210/año\n\n• 10 clientes Enterprise (€50/mes)\n  → Gana €50/mes = €600/año\n\n✅ Cuantos más clientes refiera, más gana — sin límite!",
      de: "💰 Sie verdienen 10% Provision auf jede Zahlung Ihres Kunden — FÜR IMMER!\n\n📊 Konkrete Beispiele:\n\n• 1 Starter-Kunde (€25/Monat)\n  → Sie verdienen €2,50/Monat = €30/Jahr\n\n• 5 Professional-Kunden (€35/Monat)\n  → Sie verdienen €17,50/Monat = €210/Jahr\n\n• 10 Enterprise-Kunden (€50/Monat)\n  → Sie verdienen €50/Monat = €600/Jahr\n\n✅ Je mehr Kunden Sie vermitteln, desto mehr verdienen Sie — ohne Limit!",
      mk: "💰 Заработувате 10% провизија на секое плаќање на вашиот клиент — ЗАСЕКОГАШ!\n\n📊 Конкретни примери:\n\n• 1 Starter клиент (€25/месец)\n  → Заработувате €2.50/месец = €30/год\n\n• 5 Professional клиенти (€35/месец)\n  → Заработувате €17.50/месец = €210/год\n\n• 10 Enterprise клиенти (€50/месец)\n  → Заработувате €50/месец = €600/год\n\n✅ Колку повеќе клиенти упатите, толку повеќе заработувате — без ограничување!",
    },
    quickReplies: [
      { sq: "🏦 Si paguhem?", en: "🏦 How do I get paid?", es: "🏦 Como me pagan?", de: "🏦 Wie werde ich bezahlt?", mk: "🏦 Kako се плаќам?" },
      { sq: "📋 Si aplikoj?", en: "📋 How do I apply?", es: "📋 Como aplico?", de: "📋 Wie bewerbe ich mich?", mk: "📋 Kako аплицирам?" },
  ...
  {
    keywords: {
      sq: ['si paguhem', 'si behet pagesa', 'pagesa afilimit', 'iban afiliat', 'transferte afiliat'],
      en: ['how do i get paid', 'affiliate payment', 'affiliate iban', 'affiliate transfer', 'when do i get paid'],
      es: ['como me pagan', 'pago afiliado', 'cuando me pagan', 'transferencia afiliado'],
      de: ['wie werde ich bezahlt', 'affiliate zahlung', 'wann werde ich bezahlt', 'affiliate überweisung'],
      mk: ['kako се плаќам', 'афилијат плаќање', 'кога се плаќам', 'афилијат трансфер'],
    },
    reply: {
      sq: "🏦 Si bëhen pagesat:\n\n• Metoda: Transfertë bankare direkt në IBAN tuaj\n• Kur: Deri më datën 10 të çdo muaji\n• Minimumi: €50 — nëse nuk arrihet, akumulohet muajin tjetër\n\n📋 Procesi:\n1️⃣ Aplikoni dhe aprovohet llogaria juaj\n2️⃣ Na dërgoni IBAN-in tuaj bankare\n3️⃣ Çdo muaj transferojmë komisionin automatikisht\n\n⚠️ Tatimet: Menaxhoni vetë sipas ligjit të vendit tuaj. Ne lëshojmë pasqyrë mujore si dëshmi financiare.",
      en: "🏦 How payments work:\n\n• Method: Direct bank transfer to your IBAN\n• When: By the 10th of each month\n• Minimum: €50 — if not reached, it accumulates next month\n\n📋 Process:\n1️⃣ Apply and get your account approved\n2️⃣ Send us your bank IBAN\n3️⃣ Each month we transfer your commission automatically\n\n⚠️ Taxes: Manage yourself according to your country's law. We issue monthly statements as financial proof.",
      es: "🏦 Como funcionan los pagos:\n\n• Método: Transferencia bancaria directa a su IBAN\n• Cuando: Antes del día 10 de cada mes\n• Mínimo: €50 — si no se alcanza, acumula el mes siguiente\n\n📋 Proceso:\n1️⃣ Aplique y obtenga aprobación de su cuenta\n2️⃣ Envíenos su IBAN bancario\n3️⃣ Cada mes transferimos su comisión automáticamente\n\n⚠️ Impuestos: Gestiónelos según la ley de su país. Emitimos estados mensuales como prueba financiera.",
      de: "🏦 Wie Zahlungen funktionieren:\n\n• Methode: Direkte Banküberweisung auf Ihre IBAN\n• Wann: Bis zum 10. jedes Monats\n• Minimum: €50 — wenn nicht erreicht, akkumuliert es im nächsten Monat\n\n📋 Prozess:\n1️⃣ Bewerben und Konto genehmigen lassen\n2️⃣ Senden Sie uns Ihre Bank-IBAN\n3️⃣ Jeden Monat überweisen wir Ihre Provision automatisch\n\n⚠️ Steuern: Verwalten Sie selbst gemäß dem Recht Ihres Landes. Wir stellen monatliche Abrechnungen als Finanznachweis aus.",
      mk: "🏦 Kako функционираат плаќањата:\n\n• Метод: Директен банкарски трансфер на вашиот IBAN\n• Кога: До 10-ти на секој месец\n• Минимум: €50 — ако не се достигне, акумулира следниот месец\n\n📋 Процес:\n1️⃣ Аплицирајте и добијте одобрување на вашата сметка\n2️⃣ Испратете ни го вашиот банкарски IBAN\n3️⃣ Секој месец автоматски ја префрламе вашата провизија\n\n⚠️ Даноци: Управувајте сами според законот на вашата земја. Издаваме месечни извештаи како финансиски доказ.",
    },
    quickReplies: [
      { sq: "📊 Si e di kush është aktiv?", en: "📊 How do I track clients?", es: "📊 Como sigo a mis clientes?", de: "📊 Wie verfolge ich Kunden?", mk: "📊 Kako ги следам клиентите?" },
      { sq: "📋 Si aplikoj?", en: "📋 How do I apply?", es: "📋 Como aplico?", de: "📋 Wie bewerbe ich mich?", mk: "📋 Kako аплицирам?" },
  ...
  {
    keywords: {
      sq: ['si e di kush është aktiv', 'gjurmoj klientet', 'klientet aktiv afiliat', 'raport afiliat', 'si e di kush eshte aktiv'],
      en: ['how do i track clients', 'track affiliate clients', 'active clients affiliate', 'affiliate report', 'how do i know who is active'],
      es: ['como sigo a mis clientes', 'clientes activos afiliado', 'informe afiliado', 'como sé quien está activo'],
      de: ['wie verfolge ich kunden', 'affiliate kunden verfolgen', 'aktive kunden affiliate', 'affiliate bericht', 'wie weiß ich wer aktiv ist'],
      mk: ['kako ги следам клиентите', 'активни клиенти афилијат', 'афилијат извештај', 'kako знам кој е активен'],
    },
    reply: {
      sq: "📊 Si e dini nëse klientët janë aktiv:\n\nÇdo muaj, deri më datën 5, merrni email me raport të detajuar:\n\n✅ Lista e klientëve aktiv që keni referuar\n✅ Pagesat që kanë bërë gjatë muajit\n✅ Komisioni juaj i saktë për çdo klient\n✅ Totali që do të transferohet deri më 10\n\n📧 Nëse keni pyetje për ndonjë klient specifik, shkruani direkt te info@clientlly.com — i verifikojmë brenda 24 orësh.",
      en: "📊 How you know if clients are active:\n\nEvery month, by the 5th, you receive an email with a detailed report:\n\n✅ List of active clients you have referred\n✅ Payments they made during the month\n✅ Your exact commission for each client\n✅ Total to be transferred by the 10th\n\n📧 If you have questions about a specific client, write directly to info@clientlly.com — we verify within 24 hours.",
      es: "📊 Como sabe si los clientes están activos:\n\nCada mes, antes del día 5, recibe un correo con un informe detallado:\n\n✅ Lista de clientes activos que ha referido\n✅ Pagos que realizaron durante el mes\n✅ Su comisión exacta por cada cliente\n✅ Total a transferir antes del día 10\n\n📧 Si tiene preguntas sobre un cliente específico, escriba directamente a info@clientlly.com — verificamos en 24 horas.",
      de: "📊 Wie Sie wissen, ob Kunden aktiv sind:\n\nJeden Monat, bis zum 5., erhalten Sie eine E-Mail mit einem detaillierten Bericht:\n\n✅ Liste der aktiven Kunden, die Sie vermittelt haben\n✅ Zahlungen, die sie im Laufe des Monats geleistet haben\n✅ Ihre genaue Provision für jeden Kunden\n✅ Gesamtbetrag, der bis zum 10. überwiesen wird\n\n📧 Bei Fragen zu einem bestimmten Kunden schreiben Sie direkt an info@clientlly.com — wir prüfen innerhalb von 24 Stunden.",
      mk: "📊 Kako знаете дали клиентите се активни:\n\nСекој месец, до 5-ти, добивате е-пошта со детален извештај:\n\n✅ Листа на активни клиенти кои сте ги упатиле\n✅ Плаќања кои ги направиле во текот на месецот\n✅ Вашата точна провизија за секој клиент\n✅ Вкупно за префрлање до 10-ти\n\n📧 Ако имате прашања за конкретен клиент, пишете директно на info@clientlly.com — верификуваме во рок од 24 часа.",
    },
    quickReplies: [
      { sq: "🏦 Si paguhem?", en: "🏦 How do I get paid?", es: "🏦 Como me pagan?", de: "🏦 Wie werde ich bezahlt?", mk: "🏦 Kako се плаќам?" },
      { sq: "📋 Si aplikoj?", en: "📋 How do I apply?", es: "📋 Como aplico?", de: "📋 Wie bewerbe ich mich?", mk: "📋 Kako аплицирам?" },
  ...
  {
    keywords: {
      sq: ['si aplikoj', 'ku aplikoj', 'aplikoj per afiliat', 'formulari i afilimit', 'regjistrohem si afiliat', 'dua të aplikoj'],
      en: ['how do i apply', 'where to apply', 'apply for affiliate', 'affiliate form', 'join affiliate', 'sign up affiliate', 'how to apply'],
      es: ['como aplico', 'donde aplico', 'aplicar afiliado', 'formulario afiliado', 'unirse afiliado', 'como aplicar'],
      de: ['wie bewerbe ich mich', 'wo bewerben', 'affiliate bewerben', 'affiliate formular', 'affiliate beitreten', 'wie bewerben'],
      mk: ['kako аплицирам', 'каде аплицирам', 'аплицирај за афилијат', 'афилијат формулар', 'kako да аплицирам'],
    },
    reply: {
      sq: "📋 Si të aplikoni — 4 hapa të thjeshtë:\n\n1️⃣ Shkoni te faqja: /affiliate\n2️⃣ Scrolloni poshtë te formulari \"Gati të filloni të fitoni?\"\n3️⃣ Plotësoni: emrin, emailin, telefonin dhe metodën e referimit\n4️⃣ Klikoni \"Dërgoni Aplikimin\"\n\n⏱️ Brenda 24-48 orësh:\n• Merrni email konfirmimi\n• Merrni linkun tuaj unik të referimit\n• Filloni të referoni dhe fitoni!\n\n✅ Aplikimi është plotësisht FALAS — nuk ka asnjë kosto!",
      en: "📋 How to apply — 4 simple steps:\n\n1️⃣ Go to the page: /affiliate\n2️⃣ Scroll down to the 'Ready to start earning?' form\n3️⃣ Fill in: name, email, phone and referral method\n4️⃣ Click 'Send Application'\n\n⏱️ Within 24-48 hours:\n• Receive confirmation email\n• Receive your unique referral link\n• Start referring and earning!\n\n✅ Applying is completely FREE — no cost at all!",
      es: "📋 Como aplicar — 4 pasos simples:\n\n1️⃣ Vaya a la página: /affiliate\n2️⃣ Desplácese hacia abajo al formulario 'Listo para comenzar a ganar?'\n3️⃣ Complete: nombre, email, teléfono y método de referido\n4️⃣ Haga clic en 'Enviar Solicitud'\n\n⏱️ En 24-48 horas:\n• Recibe email de confirmación\n• Recibe su enlace único de referido\n• Comience a referir y ganar!\n\n✅ Aplicar es completamente GRATIS — sin ningún costo!",
      de: "📋 So bewerben Sie sich — 4 einfache Schritte:\n\n1️⃣ Gehen Sie zur Seite: /affiliate\n2️⃣ Scrollen Sie nach unten zum Formular 'Bereit zu verdienen?'\n3️⃣ Füllen Sie aus: Name, E-Mail, Telefon und Empfehlungsmethode\n4️⃣ Klicken Sie auf 'Bewerbung senden'\n\n⏱️ Innerhalb von 24-48 Stunden:\n• Bestätigungs-E-Mail erhalten\n• Ihren einzigartigen Empfehlungslink erhalten\n• Mit der Empfehlung und dem Verdienen beginnen!\n\n✅ Die Bewerbung ist völlig KOSTENLOS — keinerlei Kosten!",
      mk: "📋 Kako да аплицирате — 4 едноставни чекори:\n\n1️⃣ Одете на страницата: /affiliate\n2️⃣ Скролувајте надолу до формуларот 'Подготвени да почнете да заработувате?'\n3️⃣ Пополнете: ime, е-пошта, телефон и метод на упатување\n4️⃣ Кликнете 'Испрати апликација'\n\n⏱️ Во рок од 24-48 часа:\n• Добивате е-пошта за потврда\n• Добивате вашиот уникатен линк за упатување\n• Започнете да упатувате и заработувате!\n\n✅ Апликацијата е целосно БЕСПЛАТНА — без никаков трошок!",
    },
    quickReplies: [
      { sq: "💰 Sa komision fitoj?", en: "💰 How much do I earn?", es: "💰 Cuanto gano?", de: "💰 Wie viel verdiene ich?", mk: "💰 Колку заработувам?" },
      { sq: "🏦 Si paguhem?", en: "🏦 How do I get paid?", es: "🏦 Como me pagan?", de: "🏦 Wie werde ich bezahlt?", mk: "🏦 Kako се плаќам?" },
