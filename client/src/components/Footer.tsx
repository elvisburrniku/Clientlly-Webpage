          ...
          <div>
            ...
            <div className="mb-5">
              ...
              <div className="flex flex-col gap-2">
                {/* App Store */}
                <a href="/mobile-app"
                  className="inline-flex items-center gap-2.5 px-3 py-2 rounded-lg bg-gray-900 hover:bg-gray-800 border border-gray-700 hover:border-gray-600 transition-all duration-200 w-fit">
                  <svg className="w-4 h-5 text-white flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-[11px] font-semibold text-white leading-tight">App Store</div>
                  </div>
                </a>
                {/* Google Play */}
                <a href="/mobile-app"
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-[11px] font-semibold text-white leading-tight">Google Play</div>
                  </div>
                </a>
              </div>
            </div>
            ...
            <div>
              <p className="text-[10px] font-semibold text-gray-600 uppercase tracking-widest mb-2.5">
                {sq(lang, "Na Ndiqni", "Follow Us")}
              </p>
              <div className="flex items-center gap-2">
                <a href="https://facebook.com/clientlly" target="_blank" rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-900 hover:bg-[#1877F2] border border-gray-700 hover:border-[#1877F2] text-gray-400 hover:text-white transition-all duration-200">
                ...
                <a href="https://instagram.com/clientlly" target="_blank" rel="noopener noreferrer"
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-900 hover:bg-gradient-to-br hover:from-[#833AB4] hover:to-[#FD1D1D] border border-gray-700 hover:border-transparent text-gray-400 hover:text-white transition-all duration-200">
                  <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor">
