...
export default function FeatureInventory() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-red-50/30 to-pink-50/30 dark:from-gray-900 dark:via-red-900/20 dark:to-pink-900/20">
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold gradient-text">Real-time Inventory</span>
            </div>
            <Button 
