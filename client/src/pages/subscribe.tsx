...
export default function Subscribe() {
  ...
  useEffect(() => {
    ...
    // Hide hero section when coming from "Buy Now" button (no plan specified)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-900 dark:to-indigo-950 relative overflow-hidden">
      ...
      {/* Hero Section - Only show when not coming from Buy Now */}
      {showHeroSection && (
      ...
      <div className={`max-w-7xl mx-auto relative z-10 px-4 ${!showHeroSection ? 'pt-32' : ''}`}>
