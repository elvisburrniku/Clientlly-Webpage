      ...
      <section className="py-10 sm:py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black text-gray-900 dark:text-white mb-4 sm:mb-6 tracking-tight leading-tight animate-professional-fade">
