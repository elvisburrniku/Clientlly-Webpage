  ...
  const stories = [
    {
      ...
      results: [
        { metric: sq(lang, "Koha e Përpunimit të Faturave", "Invoice Processing Time", "Tiempo de Procesamiento de Facturas", "Rechnungsbearbeitungszeit", "Време на Обработка на Фактури"), before: sq(lang, "40 orë/muaj", "40 hours/month", "40 horas/mes", "40 Stunden/Monat", "40 часа/месец", "40 heures/mois", "40 horas/mês", "40 ore/mese"), after: sq(lang, "4 orë/muaj", "4 hours/month", "4 horas/mes", "4 Stunden/Monat", "4 часа/месец", "4 heures/mois", "4 horas/mês", "4 ore/mese"), improvement: sq(lang, "90% reduktim", "90% reduction", "90% reducción", "90% Reduzierung", "90% намалување") },
        { metric: sq(lang, "Arkëtimi i Pagesave", "Payment Collection", "Cobro de Pagos", "Zahlungseinzug", "Наплата на Плаќања"), before: sq(lang, "45 ditë mesatare", "45 days average", "45 días promedio", "45 Tage Durchschnitt", "45 дена просек", "45 jours en moyenne", "45 dias em média", "45 giorni in media"), after: sq(lang, "18 ditë mesatare", "18 days average", "18 días promedio", "18 Tage Durchschnitt", "18 дена просек", "18 jours en moyenne", "18 dias em média", "18 giorni in media"), improvement: sq(lang, "60% më shpejt", "60% faster", "60% más rápido", "60% schneller", "60% побрзо") },
        { metric: sq(lang, "Kënaqësia e Klientëve", "Client Satisfaction", "Satisfacción del Cliente", "Kundenzufriedenheit", "Задоволство на Клиенти"), before: "3.2/5", after: "4.8/5", improvement: sq(lang, "50% rritje", "50% increase", "50% aumento", "50% Steigerung", "50% зголемување", "Augmentation de 50%", "Aumento de 50%", "Aumento del 50%") }
      ],
      ...
      person: "Sarah Chen",
      position: sq(lang, "CEO & Themeluese", "CEO & Founder", "CEO y Fundadora", "CEO & Gründerin", "CEO и Основач", "PDG & Fondateur", "CEO & Fundador", "CEO e Fondatore"),
    ...
    },
    {
      ...
      size: sq(lang, "120 punonjës", "120 employees", "120 empleados", "120 Mitarbeiter", "120 вработени", "120 employés", "120 funcionários", "120 dipendenti"),
      ...
      results: [
        { metric: sq(lang, "Incidentet e Mungesës së Stokut", "Stockout Incidents", "Incidentes de Desabastecimiento", "Fehlbestandsvorfälle", "Инциденти со Недостиг"), before: sq(lang, "24 në muaj", "24 per month", "24 por mes", "24 pro Monat", "24 месечно", "24 par mois", "24 por mês", "24 al mese"), after: sq(lang, "2 në muaj", "2 per month", "2 por mes", "2 pro Monat", "2 месечно", "2 par mois", "2 por mês", "2 al mese"), improvement: sq(lang, "92% reduktim", "92% reduction", "92% reducción", "92% Reduzierung", "92% намалување") },
        { metric: sq(lang, "Kostot e Mbajtjes së Inventarit", "Inventory Carrying Costs", "Costos de Inventario", "Bestandshaltungskosten", "Трошоци за Инвентар"), before: "€180,000", after: "€120,000", improvement: sq(lang, "33% kursim", "33% savings", "33% ahorro", "33% Einsparung", "33% заштеда", "33% d'économies", "33% de poupanças", "33% di risparmio") },
        { metric: sq(lang, "Saktësia e Pagesave të Furnitorëve", "Supplier Payment Accuracy", "Precisión de Pagos a Proveedores", "Genauigkeit der Lieferantenzahlungen", "Точност на Плаќања на Добавувачи"), before: sq(lang, "78% në kohë", "78% on-time", "78% a tiempo", "78% pünktlich", "78% навреме"), after: sq(lang, "99% në kohë", "99% on-time", "99% a tiempo", "99% pünktlich", "99% навреме"), improvement: sq(lang, "27% përmirësim", "27% improvement", "27% mejora", "27% Verbesserung", "27% подобрување", "Amélioration de 27%", "Melhoria de 27%", "Miglioramento del 27%") }
      ],
      ...
      person: "Marcus Weber",
      position: sq(lang, "Drejtor i Operacioneve", "Operations Director", "Director de Operaciones", "Betriebsleiter", "Директор на Операции", "Directeur des opérations", "Diretor de operações", "Direttore delle operazioni"),
      timeframe: sq(lang, "12 muaj", "12 months", "12 meses", "12 Monate", "12 месеци", "12 mois", "12 meses", "12 mesi")
    },
    {
      ...
      size: sq(lang, "28 punonjës", "28 employees", "28 empleados", "28 Mitarbeiter", "28 вработени", "28 employés", "28 funcionários", "28 dipendenti"),
      ...
      results: [
        { metric: sq(lang, "Marzhet e Fitimit", "Profit Margins", "Márgenes de Ganancia", "Gewinnmargen", "Профитни Маржи"), before: sq(lang, "15% mesatare", "15% average", "15% promedio", "15% Durchschnitt", "15% просек", "Moyenne de 15%", "Média de 15%", "Media del 15%"), after: sq(lang, "32% mesatare", "32% average", "32% promedio", "32% Durchschnitt", "32% просек", "Moyenne de 32%", "Média de 32%", "Media del 32%"), improvement: sq(lang, "113% rritje", "113% increase", "113% aumento", "113% Steigerung", "113% зголемување", "Augmentation de 113%", "Aumento de 113%", "Aumento del 113%") },
        { metric: sq(lang, "Koha e Dorëzimit të Projektit", "Project Delivery Time", "Tiempo de Entrega del Proyecto", "Projektlieferzeit", "Време на Испорака на Проект"), before: sq(lang, "20% me vonesë", "20% over deadline", "20% fuera de plazo", "20% über Frist", "20% по рок", "20% au-delà des délais", "20% acima do prazo", "20% oltre la scadenza"), after: sq(lang, "95% në kohë", "95% on-time", "95% a tiempo", "95% pünktlich", "95% навреме"), improvement: sq(lang, "400% përmirësim", "400% improvement", "400% mejora", "400% Verbesserung", "400% подобрување", "Amélioration de 400%", "Melhoria de 400%", "Miglioramento del 400%") },
        { metric: sq(lang, "Mbajtja e Klientëve", "Client Retention", "Retención de Clientes", "Kundenbindung", "Задржување на Клиенти"), before: "68%", after: "89%", improvement: sq(lang, "31% rritje", "31% increase", "31% aumento", "31% Steigerung", "31% зголемување", "Augmentation de 31%", "Aumento de 31%", "Aumento del 31%") }
      ],
    ...
    },
    {
      ...
      size: sq(lang, "180 punonjës", "180 employees", "180 empleados", "180 Mitarbeiter", "180 вработени", "180 employés", "180 funcionários", "180 dipendenti"),
      ...
      results: [
        ...
        { metric: sq(lang, "Saktësia e Përputhshmërisë", "Compliance Accuracy", "Precisión de Cumplimiento", "Compliance-Genauigkeit", "Точност на Усогласеност"), before: "73%", after: "98%", improvement: sq(lang, "34% përmirësim", "34% improvement", "34% mejora", "34% Verbesserung", "34% подобрување", "Amélioration de 34%", "Melhoria de 34%", "Miglioramento del 34%") },
      ...
      person: "Hans Mueller",
      position: "CFO",
      timeframe: sq(lang, "4 muaj", "4 months", "4 meses", "4 Monate", "4 месеци", "4 mois", "4 meses", "4 mesi")
    }
  ];
              ...
              >
                ...
                <div className="lg:w-1/2 space-y-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{sq(lang, "Sfida", "Challenge", "Desafío", "Herausforderung", "Предизвик", "Défi", "Desafio", "Sfida")}</h4>
                      <p className="text-gray-600 dark:text-gray-300">{story.challenge}</p>
                    </div>
                    
                    <div>
                      <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{sq(lang, "Zgjidhja", "Solution", "Solución", "Lösung", "Решение", "Solution", "Solução", "Soluzione")}</h4>
