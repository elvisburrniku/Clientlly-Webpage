...
const AboutPage = () => {
  ...
  const team = [
    ...
    {
      name: "Elvis Burrniku",
      role: sq(lang, "Bashkëthemelues & CTO", "Co-Founder & CTO", "Cofundador y CTO", "Mitgründer & CTO", "Ко-основач и CTO"),
      desc: sq(lang, "Bashkëthemelues dhe drejtori i teknologjisë së Clientlly. Arkitekt i sistemeve backend, infrastrukturës cloud, bazave të të dhënave dhe automatizimit. Siguron performancë, siguri dhe shkallëzueshmëri të platformës në çdo moment.", "Co-founder and Chief Technology Officer of Clientlly. Architect of backend systems, cloud infrastructure, databases, and automation. Ensures platform performance, security, and scalability at all times.", "Cofundador y Director de Tecnología de Clientlly. Arquitecto de sistemas backend, infraestructura en la nube, bases de datos y automatización. Asegura rendimiento, seguridad y escalabilidad de la plataforma en todo momento.", "Mitgründer und technischer Leiter von Clientlly. Architekt von Backend-Systemen, Cloud-Infrastruktur, Datenbanken und Automatisierung. Gewährleistet jederzeit Leistung, Sicherheit und Skalierbarkeit der Plattform.", "Ко-основач и главен технолошки директор на Clientlly. Архитект на бекенд системи, облак инфраструктура, бази на податоци и автоматизација. Обезбедува перформанси, безбедност и скалабилност на платформата во секое време."),
      icon: Code,
