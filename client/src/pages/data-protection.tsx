...
export default function DataProtection() {
  ...
  const certifications = [
    ...
    { icon: Award, label: "PCI DSS Level 1", desc: sq(lang,"Standardi më i lartë i sigurisë së pagesave","Highest payment security standard","El más alto estándar de seguridad de pagos","Höchster Zahlungssicherheitsstandard","Највисок стандард за безбедност на плаќања") },
    { icon: Server, label: "SOC 2 Type II", desc: sq(lang,"Auditim i pavarur i kontrollit të sigurisë","Independent security control audit","Auditoría independiente de control de seguridad","Unabhängige Sicherheitskontrollprüfung","Независна ревизија на безбедносна контрола") },
  ];

  const measures = [
    {
      icon: KeyRound,
      title: sq(lang,"Enkriptim nga fundi në fund","End-to-end encryption","Cifrado de extremo a extremo","Ende-zu-Ende-Verschlüsselung","Енкрипција од крај до крај"),
      content: sq(lang,
    ...
    {
      icon: Server,
      title: sq(lang,"Infrastrukturë e sigurt në BE","Secure EU infrastructure","Infraestructura segura en la UE","Sichere EU-Infrastruktur","Безбедна ЕУ инфраструктура"),
      content: sq(lang,
    ...
    {
      icon: FileCheck,
      title: sq(lang,"Backup automatik ditor","Automatic daily backups","Copias de seguridad diarias automáticas","Automatische tägliche Backups","Автоматски дневни резервни копии"),
      content: sq(lang,
    ...
    {
      icon: Users,
      title: sq(lang,"Kontrolli i aksesit me role","Role-based access control","Control de acceso basado en roles","Rollenbasierte Zugriffskontrolle","Контрола на пристап базирана на улоги"),
      content: sq(lang,
    ...
    {
      icon: AlertTriangle,
      title: sq(lang,"Monitorim dhe detektim 24/7","24/7 monitoring and detection","Monitoreo y detección 24/7","24/7 Überwachung und Erkennung","24/7 мониторинг и детекција"),
      content: sq(lang,
    ...
    {
      icon: Globe,
      title: sq(lang,"Përputhshmëri GDPR","GDPR compliance","Cumplimiento del RGPD","DSGVO-Konformität","Усогласеност со GDPR"),
      content: sq(lang,
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-14 px-6 lg:px-8 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-indigo-50 border border-indigo-100 rounded-full mb-5">
            ...
            <span className="text-xs font-semibold text-indigo-700">{sq(lang,"Mbrojtja e të Dhënave","Data Protection","Protección de datos","Datenschutz","Заштита на податоци")}</span>
          </div>
      ...
      <section className="py-14 px-6 lg:px-8 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-extrabold text-gray-900 mb-2">
            {sq(lang,"Masat teknike të sigurisë","Technical security measures","Medidas técnicas de seguridad","Technische Sicherheitsmaßnahmen","Технички безбедносни мерки")}
          </h2>
          <p className="text-gray-400 text-sm mb-10">
            {sq(lang,"Si mbrojmë të dhënat tuaja çdo sekondë të çdo dite","How we protect your data every second of every day","Cómo protegemos sus datos cada segundo de cada día","Wie wir Ihre Daten jede Sekunde jeden Tages schützen","Како ги штитиме вашите податоци секоја секунда од секој ден")}
          </p>
      ...
      <section className="py-14 px-6 lg:px-8 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-extrabold text-gray-900 mb-2">
            {sq(lang,"Të drejtat tuaja sipas GDPR","Your rights under GDPR","Sus derechos bajo el RGPD","Ihre Rechte unter der DSGVO","Вашите права според GDPR")}
          </h2>
          <p className="text-gray-400 text-sm mb-10">
