        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex justify-center items-center space-x-4 mt-6">
                ...
                <div className="w-4 h-4 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-full animate-pulse"></div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-3xl p-8 lg:p-16 shadow-2xl border border-white/20 dark:border-gray-700/30 relative overflow-hidden group hover:shadow-3xl transition-all duration-500">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 opacity-20 rounded-3xl"></div>
              ...
              <div className="relative z-10 text-center space-y-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 mt-12">
                  ...
                  <div className="group/item bg-indigo-50/80 dark:bg-indigo-900/30 rounded-2xl p-6 hover:bg-indigo-100/90 dark:hover:bg-indigo-900/50 transition-all duration-300 hover:scale-105 hover:shadow-lg delay-200">
