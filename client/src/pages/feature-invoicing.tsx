            ...
            <div className="relative fade-in stagger-3">
              ...
              <div className="relative mb-8">
                <img 
                  ...
                  alt="Professional invoicing workflow in modern office"
                ...
                <div className="absolute -bottom-6 left-6 bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-lg">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Invoice sent & tracking active</span>
                  </div>
                </div>
              </div>
              ...
              <Card className="relative glass-effect border-white/20 p-8">
                <CardContent className="space-y-6">
                  <div className="flex items-center justify-between">
                    <h3 className="text-2xl font-bold">Invoice #INV-2024-001</h3>
                    <Badge className="bg-green-100 text-green-700">Paid</Badge>
                  </div>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center p-4 bg-white/50 rounded-lg">
                      <span className="font-medium">Software Development - Q1 2024</span>
                      <span className="font-bold text-blue-600">$12,500.00</span>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-white/50 rounded-lg">
                      <span className="font-medium">UI/UX Design Services</span>
                      <span className="font-bold text-blue-600">$3,750.00</span>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-white/50 rounded-lg">
                      <span className="font-medium">Project Management</span>
                      <span className="font-bold text-blue-600">$2,250.00</span>
                    </div>
                    <div className="border-t pt-4 space-y-2">
                      ...
                      <div className="flex justify-between items-center border-t pt-2">
                        ...
                        <span className="text-2xl font-bold text-blue-600">$20,072.50</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    Due Date: March 15, 2024 • Payment Terms: Net 30
                  </div>
                </CardContent>
              </Card>
            </div>
