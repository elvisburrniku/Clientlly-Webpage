...
const data = {
  ...
  tagline: { sq: "Pa pajisje në zyrë — vetëm telefon dhe GPS", en: "No office devices — just phone and GPS" },
  ...
  benefits: [
    ...
    { sq: "Caktim orarit dhe turneve të punës", en: "Scheduling working hours and shifts" },
