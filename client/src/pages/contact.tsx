        ...
        <div className="max-w-[1800px] mx-auto px-6 sm:px-8 lg:px-20">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              <Link href="/contact" className="text-sm text-primary transition-all duration-300 font-bold">Contact Us</Link>
            </div>
        ...
        {showMobileMenu && (
          <div className="lg:hidden glass-effect border-b border-white/20 slide-in-bottom">
            <div className="px-4 py-4 space-y-4">
              ...
              <Link href="/contact" className="block text-sm text-primary transition-colors font-bold">Contact Us</Link>
