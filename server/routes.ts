...
const SUBSCRIPTION_PLANS = {
  basic: {
    ...
    features: [
      ...
      "Menaxhim Inventari",
      "Mirëmbajtje & Servisim i Automjeteve",
      "Prezencë (GPS)",
      "Burimet Njerëzore",
      "Kalendari",
      "Akses aplikacioni mobil",
      "Integrime API",
      "Siguri bankare & mbrojtje e të dhënave",
      "Mbështetje 24/7"
    ],
    detailedFeatures: {
      invoicing: {
  ...
  professional: {
    ...
    features: [
      ...
      "Siguri bankare & mbrojtje e të dhënave",
      "Mbështetje 24/7",
      "**Le të Rritemi Bashkë** — Zhvillim falas i veçorive"
    ],
    detailedFeatures: {
      invoicing: {
  ...
  business: {
    ...
    description: "",
    features: [
      "**Deri në 20 përdorues** (€2/përdorues shtesë)",
      "Fatura të Pakufizuara",
      "Ofertat",
      "Gjurmim Shpenzimesh",
      "Menaxhim Borxhesh",
      ...
      "Siguri bankare & mbrojtje e të dhënave",
      "Mbështetje 24/7",
      "**Le të Rritemi Bashkë** — Zhvillim prioritar i personalizuar"
    ],
    detailedFeatures: {
      invoicing: {
        "Monthly invoices": "Unlimited",
